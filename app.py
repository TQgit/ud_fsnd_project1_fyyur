...
def venues():
    ...
    # db.session.add(Venue(name='The Casino del Tam', city='Alba', state='CA', address='egg road', phone='992839282',
    #                      image_link='http://test.com/o.jpg', facebook_link='http://facebook.com/o.jpg',
    #                      website='http://test.com/', genres=['Electronic', 'Other'],
    #                      is_seeking_talent=True, seeking_description='join us'))
...
def artists():
    ...
    # db.session.add(Artist(name='Fairouz', city='Beirut', state='MA',
    #                       image_link='https://i1.sndcdn.com/artworks-000088145964-44k8gg-t500x500.jpg',
    #                       facebook_link='http://facebook.com/',
    #                       website='http://test.com/', genres=['Folk', 'Jazz', 'Other'],
    #                       is_seeking_venue=True, seeking_description='We are looking for a stage!'))
